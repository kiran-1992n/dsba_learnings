...
-- When there are 2 values same in first_name then we consder last_name for sorting
...
-- limit 2 means 2 rows required and offset 5 means skip rows till 5 and give 6th and 7th rows(2 rows)
select * from employees
limit 2 offset 5
;
...
-- We need to have equal number of columns in both select queres
